...
- **Overview / dashboard sheet**: a title + one-line takeaway, 3–4 KPI figures (give each value enough column width or **merge across columns** so a wide value like `$1,400,000,000` can't overflow into the next), and a compact ranking with data bars.
